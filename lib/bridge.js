...
function runPHP(req, response, next, phpinfo){
  ...
  var script_name = parts.pathname;
  if(i > 0) {
    // if '.php' exists in url, assume it is the end of the script_name
    script_name = parts.pathname.substring(0, i+4);
  }
  ...
  var env = {
    ...
    SCRIPT_NAME: script_name, //The virtual path of the script being executed.
